...
<div id="page_contact">
    ...
    <div class="information">
        <div> <img src="../public/images/Icone%20_localisation.png" width="20" height="20"> <?php echo $donnees['adresse']?></div>
        <div> <img src="../public/images/Icone_telephone.png" width="20" height="20"> <?php echo $donnees['numero_tel']?></div>
    </div>
...
<div class="map">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2625.6723360750684!2d2.3259462154355663!3d48.845388409576486
     ...
     +Paris!5e0!3m2!1sfr!2sfr!4v1495021372339" width="1540" height="250" frameborder="5" style="border:0" allowfullscreen></iframe>
</div>
