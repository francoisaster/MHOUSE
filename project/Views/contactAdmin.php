...
<div class="infos-contact">
        <div> <img src="Image/Icone_localisation.png" width="24" height="24"> <?php echo $donnees['adresse']?></div>
        <div> <img src="Image/Icone_telephone.png" width="24" height="24"> <?php echo $donnees['numero_tel']?></div>
        <div> <img src="Image/Icone_email.png" width="24" height="24"> <?php echo $donnees['email']?></div>
    </div>
...
<form action="../Controllers/contactAdmin.php" method="post" >
    <fieldset>
        <legend>Modifier les info de contact :</legend>
        <p>
